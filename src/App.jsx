    ...
    <Routes>
      ...
      <Route element={<RequireAuth allowedRoles={["4"]} />}>
        <Route element={<Layout />}>
          ...
          <Route
            path="/custom-products-shape/:productId?"
            element={<ShapePage />}
          />
          <Route
            path="/custom-products-size/:productId?"
            element={<SizePage />}
          />
          <Route
            path="/custom-products-material/:productId?"
            element={<MaterialPage />}
          />
          <Route
            path="/custom-products-color/:productId?"
            element={<ColorPage />}
          />
          <Route
            path="/custom-products-end/:orderId?/:productId?"
            element={<TotalPage />}
          />
