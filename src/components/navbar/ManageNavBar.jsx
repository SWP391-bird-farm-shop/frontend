            ...
            <nav className={`manage-navbar ${className}`}>
                <Nav id='manage-navbar'>
                    ...
                    <NavMenu className='first-role-section'>
                        <NavLink to='/manage-account' className='first-section-component-admin'>
                            Quản lí tài khoản
                        </NavLink>
                    </NavMenu>
        ...
        return (
            <nav className={`manage-navbar ${className}`}>
                <Nav id='manage-navbar'>
                    ...
                    {/* manager */}
                    <NavMenu className='first-role-section'>
                        <NavLink to='/product/view-product' className='first-section-component-manager'>
                            Quản lí sản phẩm
                        </NavLink>
                        <NavLink to='/voucher/view-voucher' className='first-section-component-manager'>
                            Quản lí voucher
                        </NavLink>
                    </NavMenu>
                    <div className='second-role-section'>
