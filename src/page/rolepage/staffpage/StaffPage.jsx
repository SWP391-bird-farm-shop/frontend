  ...
  return (
    <div className="role-page">
      ...
      <div className="role-page-manage-tasks">
        <Link to="/staff/manage-blogs/view-blog" className="role-page-manage-task">
         ...
         <Link to="/staff/feedback/view-product" className="role-page-manage-task"> 
         ...
         <Link to="/staff/order/view-order" className="role-page-manage-task"> 
