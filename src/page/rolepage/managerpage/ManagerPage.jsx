  ...
  return (
    <div className="role-page">
      ...
      <div className="role-page-manage-tasks">
        <Link to={`/manager/product/view-product`} className="role-page-manage-task">
        ...
        <Link to={`/manager/voucher/view-voucher`} className="role-page-manage-task">
        ...
        <Link to={`/manager/dashboard`} className="role-page-manage-task">
